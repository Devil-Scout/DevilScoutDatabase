...
REVOKE ALL PRIVILEGES ON TABLE frc_seasons FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_districts FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_events FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_district_events FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_teams FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_district_teams FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_event_teams FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_matches FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_match_teams FROM public, anon, authenticated;
...
REVOKE ALL PRIVILEGES ON TABLE frc_match_results FROM public, anon, authenticated;
